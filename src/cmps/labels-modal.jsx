...
export function LabelsModal({ setStatus, field, closeModal, parentRef }) {
    ...
    return <Fragment>
        <div ref={ wrapperRef }>
            ...
            <div style={ { backgroundColor: 'rgb(173, 150, 122)' } } className="btn-wraper"> <div onClick={ () => setStatus('none', field) } className="status-edit-btn"><div className="none">none</div></div></div>
