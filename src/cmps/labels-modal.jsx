...
export function LabelsModal({ setStatus, field, closeModal, parentRef, changeColor, setChangeColor }) {
    ...
    return <>
        <div ref={wrapperRef}>
            ...
            <div className="btn-wraper"> <div className="status-edit-btn " ><div className="add-edit-btn flex " onClick={(ev) => changeColor(ev)}><EditColor />Add/Edit Labels</div></div></div>
        </div>
    </>
}